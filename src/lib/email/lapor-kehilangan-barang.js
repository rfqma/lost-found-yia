export const userMailHTML =
  (reporterName, reporterPhoneNumber, reporterMessage, reporterEmail, reporterEmailDisplayName) => {
    return `
    ...
    <body>
      <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
            ...
            <h3>👋🏼 Halo ${reporterName}, Laporanmu sudah kami terima!</h3>
            <div style="font-size: 16px;">
            <p>
            Nama: ${reporterEmailDisplayName} <br />
            Email: ${reporterEmail} <br />
            Nomor Telepon: ${reporterPhoneNumber} <br />
            Pesan: <br />
            ${reporterMessage}
            </p>
            <p>
            Kami akan memproses laporanmu secepat mungkin! Kamu akan dihubungi dalam waktu 48 jam, sabar ya!
            <br />
            Jika kamu tidak dihubungi dalam waktu 48 jam, silahkan hubungi kami kembali.
            </p>
            <br />
            </div>
  ...
  (reporterName, reporterPhoneNumber, reporterMessage, reporterEmail, reporterEmailDisplayName) => {
    ...
    <body>
      <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
            ...
            <div class="container" style="margin-left: 20px;margin-right: 20px;">
            <h3>⚠️ Rincian Laporan barang hilang oleh ${reporterName}</h3>
            <div style="font-size: 16px;">
            <p>
            Nama: ${reporterEmailDisplayName} <br />
            Email: ${reporterEmail} <br />
            ...
            <p>
            Dimohon untuk melakukan review dan memberikan feedback atau merespon pelapor dalam waktu 48 jam!
            </p>
            <br />
            </div>
            <a href="http://localhost:3000/"><img src="https://firebasestorage.googleapis.com/v0/b/lost-found-yia.appspot.com/o/foundItemsImage%2FMpuklX20190503080722.png?alt=media&token=968b82a1-248a-4c0e-8659-8e0b39813d97" class="logo-image" style="height: 50px;width: 150px;border-radius: 5px;overflow: hidden; background-color: #fff"/></a>
